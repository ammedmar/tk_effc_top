\documentclass[10pt,t,aspectratio=54,handout]{beamer} % handout aspectratio=149,1610,32,54
\usetheme{Heverlee}
...
\title{Effective constructions in algebraic topology and topological data analysis}
\subtitle{Celebrating Gunnar's birthday in Minnesota}
