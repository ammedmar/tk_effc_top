...
% (D) Add logo to bottom right-corner (optional)
    \logo{\includegraphics[height=0.7cm]{aux/logo}\hspace{12pt}\vspace{-4pt}}
...
\title{Effective algebro-homotopical constructions and applications}
\subtitle{Universidad Complutense de Madrid \\ Seminario de \'Algebra, Geometr\'ia y Topolog\'ia}
